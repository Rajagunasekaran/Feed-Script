...
<head>
	...
	<style type="text/css">
		...
		.feedback-wrap .entry-content h3 {
			margin-top: 0; margin-bottom: 0; color: #22a7f0; text-align: center;
		}
		.feedback-wrap .btn-info:hover, .feedback-wrap .btn-info:focus, .feedback-wrap .btn-info:active:hover {
			background-color: #2b7dac;
			border-color: #2072a0;
		}
		.feedback-wrap .btn-info {
			background-color: #22a7f0;
			border-color: #27a1e4;
			font: 16px ralewaymedium;
			text-transform: uppercase;
		}
		.feedback-wrap textarea.form-control:focus {
			border-color: #22a7f0;
		}
		...
		.feedback-wrap .alert { padding: 8px 15px; margin-top: 20px; }
		...
		.feedback-wrap label.control { margin-bottom: 0; }
	...
	<div class="header-section ts_headersection">
							...
							<nav class="navbar navbar-default" role="navigation">
								...
								<div class="collapse navbar-collapse navbar-primary-collapse">
									<ul id="menu-menu-1" class="nav navbar-nav">
										<li id="menu-item-18" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-18"><a href="http://tendersoftware.com/">Home</a></li>
											...
											<div class="headercontact">
												<ul class="regions">
													...
													<li class="ineternational" class="dropdown" data-dropdown="dropdown"><a href="javascript:void(0)"  class="dropdown-toggle" data-toggle="dropdown">INTERNATIONAL SITES <span class="caret"></span></a>
														<ul class="sub-menu dropdown-menu">
															<li class="">
																<a href="http://tendersoftware.com.au">
			...
			<div id="content" class="row row-with-vspace site-content">
				<div class="col-md-8 col-md-offset-2 content-area" id="main-column">
					<main id="main" class="site-main" role="main">
						<article id="post-344" class="post-344 page type-page status-publish hentry feedback-wrap wow bounceInUp" data-wow-delay="0.4s">
							...
							<div class="entry-content">
								...
								if(isset($type) && $type > 0 ) {
									if($type == 4 ) {
										?>
										<div class="custom-title"><strong>Please help to understand more:</strong></div>
										<form class="form" method="post" action="" onsubmit="return feedback_validation();" >
											<div class="form-group">
												<div class="row">
													<div class="col-sm-12">
														<label class="control control--checkbox">Under skilled developers
															<input type="checkbox" class="feedback_text" name="feedback_text[]" value = "4_A">
											...
											<div class="form-group">
												<div class="row">
													<div class="col-sm-12">
														<label class="control control--checkbox">Poor communication, does not understand the requirements
															<input type="checkbox" class="feedback_text" name="feedback_text[]" value = "4_B">
															<div class="control__indicator"></div>
														</label>
													</div>
												</div>
											...
											<div class="form-group">
												<div class="row">
													<div class="col-sm-12">
														<label class="control control--checkbox">Careless approach not following standards
															<input type="checkbox"  class="feedback_text" name="feedback_text[]" value = "4_C">
															<div class="control__indicator"></div>
														</label>
													</div>
												</div>
											...
											<div class="form-group">
												<div class="row">
													<div class="col-sm-12 div_feedback_btn">
														<button type="submit" class="btn btn-info btn-lg btn_feedback" name="btn_feedback">Submit</button>
													</div>
												</div>
											</div>
										</form>
										...
										if($type == 3 ) {
											...
											<form class="form" method="post" action="" onsubmit="return feedback_validation();" >
												<div class="form-group">
													<div class="row">
														<div class="col-sm-12">
															<label class="control control--checkbox">Developer needs too much explanation
																<input type="checkbox" class="feedback_text" name="feedback_text[]" value = "3_A" >
																<div class="control__indicator"></div>
															</label>
														</div>
													</div>
												...
												<div class="form-group">
													<div class="row">
														<div class="col-sm-12">
															<label class="control control--checkbox">Slow progress
																<input type="checkbox" class="feedback_text" name="feedback_text[]" value = "3_B" >
																<div class="control__indicator"></div>
															</label>
														</div>
													</div>
												...
												<div class="form-group">
													<div class="row">
														<div class="col-sm-12">
															<label class="control control--checkbox">Too many bugs produced
																<input type="checkbox" class="feedback_text" name="feedback_text[]" value = "3_C">
																<div class="control__indicator"></div>
															</label>
														</div>
													</div>
										...
										if($type == 2 ) {
											...
											<form class="form" method="post" action="" onsubmit="return feedback_validation();" >
												<div class="form-group">
													<div class="row">
														<div class="col-sm-12">
															<label class="control control--checkbox">Ok but improvement is possible
																<input type="checkbox" class="feedback_text" name="feedback_text[]" value = "2_A" >
																<div class="control__indicator"></div>
															</label>
														</div>
													</div>
										...
										if($type == 1 ) {
											?>
											<div class="custom-title"><strong>Great! Thanks for letting us know!</strong></div>
		...
		<script>
			jQuery(window).bind("load", function() {
				jQuery('#top-a > div > .module').removeAttr('style');
				jQuery(window).resize();
				jQuery('#top-a > div > .module').attr('style', 'min-height:1px;');
			});
